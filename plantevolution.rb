...
def populate
    ...
    ($yrange+1).times do
        ($xrange+1).times do
           # Terrain.new(-7, x, y, 1, rand(80-90), rand(30..40), 18,  "path", 0, rand(500000..1000000))
            x+=1
        end
        x  = 0
        y+=1
    ...
    pngholder = ChunkyPNG::Image.from_file('urthseeds.png')
    ...
    Terrain.new(-9, x, y, 1, 0, 0, 180,  "path", 5, 1000000000, 2000000)
        ...
        d = Terrain.new(-1, x, y, 1, rand(170..180), rand(110..120), 78,  "path", 0, rand(1000..2999), 100)
    elsif ChunkyPNG::Color.b(pngholder[x, y]) == 0 && ChunkyPNG::Color.g(pngholder[x, y]) == 0 && ChunkyPNG::Color.r(pngholder[x, y]) == 0
        Terrain.new(-4, x, y, 1, rand(100..110), rand(60..70), 48,  "path", 0, rand(25000..59999), 750)
    elsif ChunkyPNG::Color.b(pngholder[x, y]) == 0 && ChunkyPNG::Color.g(pngholder[x, y]) == 255 && ChunkyPNG::Color.r(pngholder[x, y]) == 0
        Terrain.new(-3, x, y, 1, rand(90..100), rand(50..60), 38,  "path", 0, rand(105000..159999), 1000)
     elsif  ChunkyPNG::Color.g(pngholder[x, y]) == 102
        Terrain.new(-7, x, y, 1, rand(70..90), rand(30..40), 18,  "path", 0, rand(500000..1000000), 2000)
    else
        Terrain.new(-9, x, y, 1, 30, 30, 210,  "path", 2, 25000000, 1000000)
    end
   ...
   #  caste = rand(0..7)
    # caste = (x*2) % 7
     ...
     when 5
        ...
        when 7
            d = Terrain.new(-8, x, y, 1, rand(150..170), rand(150..170), 100,  "path", 0, -1, 20000)
        when 8
            h = rand(5)
 ...
 def interact(front, back)
  #  ##puts front.name
    ...
    if front.name < 5  && back.name > 4
        ...
        front.energy = 0
        front.growthrate = 0
        front.inventory.each do |seed| back.inventory  <<  seed end
         if front != nil
...
GC.start(full_mark: true, immediate_sweep: true);
 ...
 def germinate(object)
    ...
    if rand(250000000000) <  (object.moisture * object.energy)
    if object.inventory.length > 0 && Fighter.sortedplants[object.x][object.y] == nil
         ...
         #   Plant.new(chosenseed.traits[0], fuzzer_x(fuzzer_x(object.x)), fuzzer_y(fuzzer_y(object.y)), 1,  chosenseed.traits[4],   chosenseed.traits[5],   chosenseed.traits[6],  "plant",   chosenseed.traits[7],   chosenseed.traits[8],   chosenseed.traits[9],  [],   chosenseed.traits[10])
               chosenseed = object.inventory.delete(chosenseed)
...
def prodginate(plant)
    return Prodgenitor.new(11, 1, "prodegeny",  [plant.name, 0, 0, plant.status,  fuzzer_c(plant.r), fuzzer_c(plant.g), fuzzer_c(plant.b), plant.type,  plant.depth, fuzzer_g(10002), fuzzer(plant.growthrate), [],  [fuzzer_g(60000) , (plant.traits[1]),  (plant.traits[2]+rand(-100..100))]])
end
...
d
 ...
 def predator_generator(a, b, x, y)
    ...
    if Fighter.sortedsands[x][y].name != -9
     ...
     case c
     when 0
         d = Predator.new(101, x, y, 1, 255, (rand(20)+20), rand(50), "pred", 0, (belllcurve(250000)+600000), (belllcurve(3000)+1500), [], [belllcurve(100), 1, (belllcurve(10)+20)])
        when 1
            d = Predator.new(102, x, y, 1, 255, (rand(20)), rand(10), "pred", 0, (belllcurve(500000)+800000), (belllcurve(2000)+1200),  [], [belllcurve(100), 1, (belllcurve(10)+40)])
        when 2
            d = Predator.new(103, x, y, 1, 0, 0, 0, "pred", 0, (belllcurve(1000000)+1000000), (belllcurve(1500)+700), [],  [belllcurve(100), 1, (belllcurve(10)+60)])
     else 
 ...
 def provideanimals(a, b, x, y)
    ...
    if Fighter.sortedsands[x][y].name != -9
     ...
     when 0
        if rand(2) != 0
            d = Herbivore.new(6, x, y, 1, 255, (rand(25)+134), rand(25), "herbi", 0, (belllcurve(240000)+10000), (belllcurve(1500)+1000),  [],  [belllcurve(100), 0, (belllcurve(5)+3), 30])
        else
            d = Herbivore.new(8, x, y, 1, 90,90, 110, "herbi ", 0, (belllcurve(900000)+10000), (belllcurve(500)+500),  [], [belllcurve(100), 0, (belllcurve(7)+6), 100])
        end
        when 1
            d = Herbivore.new(7, x, y, 1, rand(20), (rand(1)+134), 200, "herbi", 0, (belllcurve(499000)+100000), (belllcurve(1500)+500),  [],  [belllcurve(100), 0, (belllcurve(6)+4), 50])
        when 2
            d = Herbivore.new(8, x, y, 1, 90, 90, 110, "herbi ", 0, (belllcurve(900000)+10000), (belllcurve(500)+500),  [],  [belllcurve(100), 0, (belllcurve(7)+6), 100])
     else 
        d = Herbivore.new(6, x, y, 1, 255, (rand(25)+134), rand(25), "herbi", 0, (belllcurve(240000)+10000), (belllcurve(1500)+1000),   [],  [belllcurve(100), 0, (belllcurve(5)+3), 30])
            ...
            pngx[object.x, object.y] = ChunkyPNG::Color.rgba(object.r, object.g, object.b, 255)
                ...
                toilet = Fighter.sortedsands[object.x][object.y]
                    ...
                    if object.type == "plant"
                       object.inventory << Prodgenitor.new(11, 1, "prodegeny",  [object.name, 0, 0, object.status,  fuzzer_c(object.r), fuzzer_c(object.g), fuzzer_c(object.b), object.type,  object.depth, fuzzer_g(10002), fuzzer(object.growthrate), [],  [fuzzer_g(60000) , (object.traits[1]),  (object.traits[2]+rand(-100..100))]]) 
                    end
                    end
                    end
            end
...
Fighter.sortedherbis[object.x][object.y] = nil
leftright = []
updown = []
    ...
    Fighter.sortedherbis[object.x][object.y] = object
            ...
            if object.name > 5 && object.name < 99
                ...
                if object.inventory.length > 0
                    if true # rand(object.traits[3]) == 0
                        chosenseed = object.inventory[rand(object.inventory.length)]
...
if Fighter.sortedherbis[x] != nil
    ...
    updown << Fighter.sortedherbis[x][y]
    end
end
    x+=1
end
...
if x > ($xrange+1)
    ...
    leftright << Fighter.sortedherbis[x][y]
    end
    y+=1
end
