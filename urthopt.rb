...
class Fighter
    ...
    attr_accessor :name, :status, :x, :y,  :r, :g, :b,  :all, :path, :plants, :herbis, :predos, :water, :sortedsands, :sortedplants, :sortedpredos, :sortedherbis
    @@all = []
    @@paths = []
    @@plants = []
    @@herbis = []
...
def populate
   ...
   # Weather.new(-999, ($xrange/2), $yrange, "redsun", 255, 0, 0, 1, (belllcurve(500000)+3000000))
    ...
    pngholder = ChunkyPNG::Image.from_file('seedurths.png')
    ...
    elsif ChunkyPNG::Color.b(pngholder[x, y]) == 0 && ChunkyPNG::Color.g(pngholder[x, y]) == 102 && ChunkyPNG::Color.r(pngholder[x, y]) == 0
