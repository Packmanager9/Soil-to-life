...
GC.start(full_mark: true, immediate_sweep: true);
 ...
 def provide_cloud(x, y, z, season)
    ...
    Weather.new(-100, x, y, 1, 255, 255, 255, rand(50..178), (rand(5)+3))
    end
 end
...
GC.start(full_mark: true, immediate_sweep: true);
 ...
 def rain(soil, cloud) #changes soil to fit adding water and breaking down waste and the dead
    ...
    if (rand 0..3) == 0 #makes it rain less continously
 ...
 def provideanimals(a, b, x, y)
     ...
     when 0
        if rand(2) != 0
         d = Herbivore.new(6, x, y, 1, 255, (rand(1)+134), rand(255), "herbi", 0, (belllcurve(240)+10), (belllcurve(3)+2), [belllcurve(100), 0])
        else
            d = Herbivore.new(8, x, y, 1, 150,150, 170, "herbi ", 0, (belllcurve(900)+10), (belllcurve(1)+1), [belllcurve(100), 0])
        end
        when 1
            d = Herbivore.new(7, x, y, 1, rand(20), (rand(1)+134), 200, "herbi", 0, (belllcurve(499)+100), (belllcurve(3)+1),  [belllcurve(100), 0])
        when 2
            d = Herbivore.new(8, x, y, 1, 150,150, 170, "herbi ", 0, (belllcurve(900)+10), (belllcurve(1)+1),  [belllcurve(100), 0])
     else 
         d = Herbivore.new(6, x, y, 1, 255, (rand(1)+134), rand(255), "herbi", 0, (belllcurve(240)+10), (belllcurve(3)+2),  [belllcurve(100), 0])
...
if soil.status !=0
    ...
    if  (season%2) == 1
     ...
     if soil.name == -9 &&  rand(8000000) < soil.energy
        zrat = z/season
                ...
                if object.name != 103
                   ...
                   object.x = fuzzer_x(object.x)
                    ...
                    object.y = fuzzer_y(object.y)
                        ...
                        leftright = []
                        updown = []
                        leftright = (Herbivore.all.select do |prey|  prey.x == object.x && (prey.name < 99 && prey.name > 5) end)
                        updown = (Herbivore.all.select do |prey|  prey.y == object.y  && (prey.name < 99 && prey.name > 5) end)
                            if rand(0..1) == 0
                            if leftright.length != 0
                               ...
                               quarry =  leftright.select do |prey| prey.name < 99 &&  prey.name > 4 end
                                ...
                                if quarry.y > object.y && (quarry.x == object.x)
                                    pngx[object.x, object.y] = ChunkyPNG::Color.rgba(object.r, object.g, object.b, 255)
                                    object.y += 1
                                    pngx[object.x, object.y] = ChunkyPNG::Color.rgba(255, 180, object.b, 255)
                ...
                if object.name > 99 
                 ...
                 #   ##puts "#{object.energy},  #{object.growthrate}" 
                    ...
                    if (object.energy > 55000 && object.name == 103) ||  (object.energy > 35000 && object.name == 102) ||  (object.energy > 25000 && object.name == 101)
                        ...
                        object.energy -= 35000
                        ##puts "New Tiger!"
                        Predator.new(object.name, object.x, object.y, object.status, [object.r+rand(-10..10), 255].min, [object.g+rand(-10..10), 150].min, [object.b+rand(-10..10), 255].min, object.type, object.depth, 1000, object.growthrate)
                        elsif object.name ==102
                            object.energy -= 20000
                            ##puts "New Pythons!"
                            Predator.new(object.name, object.x, object.y, object.status, [object.r+rand(-10..10), 255].min, [object.g+rand(-10..10), 150].min, [object.b+rand(-10..10), 255].min, object.type, object.depth, 600, object.growthrate)
                            Predator.new(object.name, object.x, object.y, object.status, [object.r+rand(-10..10), 255].min, [object.g+rand(-10..10), 150].min, [object.b+rand(-10..10), 255].min, object.type, object.depth, 600, object.growthrate)
                        elsif object.name == 101
                            object.energy -= 10000
    
                        ##puts "New Mongooses!"
                        Predator.new(object.name, object.x, object.y, object.status, [object.r+rand(-10..10), 255].min, [object.g+rand(-10..10), 150].min, [object.b+rand(-10..10), 255].min, object.type, object.depth, 100, object.growthrate)
                        Predator.new(object.name, object.x, object.y, object.status, [object.r+rand(-10..10), 255].min, [object.g+rand(-10..10), 150].min, [object.b+rand(-10..10), 255].min, object.type, object.depth, 100, object.growthrate)
                        Predator.new(object.name, object.x, object.y, object.status, [object.r+rand(-10..10), 255].min, [object.g+rand(-10..10), 150].min, [object.b+rand(-10..10), 255].min, object.type, object.depth, 100, object.growthrate)
                        end
                    end
            ...
            dace = gather.find do |obj| obj.name == -9 end
                        ...
                        if bace != nil && ace != nil
                         ...
                         if cace != nil && ace != nil
                            ...
                            if cace.name != -100 && ace.name != -100  && (cace.name > -1 && ace.name > -1)
                            predation(cace, ace)
                            #$eaten+=1
                            end
                         end
...
Plant.all.delete_if do |obj| dead.include?(obj) end
     ...
     #   end
            clouds.each do |cloud|
                ...
                cloudred =  cloud.r * (cloud.a/10)
                cloudgreen =  cloud.g * (cloud.a/10)
                cloudblue = cloud.b * (cloud.a/10)
