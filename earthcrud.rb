...
def populate
    ...
    Terrain.new(-9, x, y, 1, 0, 0, 180,  "path", 5, 1000000000, 2000000)
        ...
        Terrain.new(-3, x, y, 1, rand(90..100), rand(50..60), 38,  "path", 0, rand(105000..159999))
 ...
 def predation(front, back)
    ...
    if front.name > back.name  && (back.name > 4 && back.name < front.name)
      #  ####puts "#{(back.energy*5)} !!!!!!!"
        ...
        Fighter.sortedherbis.delete(Fighter.sortedherbis[front.x][front.y])
            ...
            if rand(0..3) == 0
                ...
                solarsize.times do
                            ...
                            (solarsize).times do
                                ...
                                if Fighter.sortedsands[fuzzx][fuzzy].name == -9 && rand(13000) == 0  ##-9 is water, sortedsands is categorized array of terrain objects
                                    zrat = (z/season)+10
